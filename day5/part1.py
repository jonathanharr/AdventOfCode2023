...
def set_des_sour_rang_to_list(des_sour_rang_as_list, line_to_look_for):
    ...
    print(des_sour_rang_as_list)


def get_destination_from_source_using_list(des_sour_rang_as_list, key_to_look_for):
    for i in range(len(des_sour_rang_as_list)):
        destination_source_range = des_sour_rang_as_list[i]
...
def main():
    ...
    for i in range(len(numbers)):
        number = numbers[i]
        loc = get_location_to_seed(number)
